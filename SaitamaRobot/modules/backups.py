...
def export_data(update, context):
    ...
    f = open("Mai_Sakurajima_Robot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Mai_Sakurajima_Robot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("Mai_Sakurajima_Robot{}.backup".format(chat_id))  # Cleaning file
